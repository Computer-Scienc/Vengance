...
void VGraph::Init()
{
    ...
    nge.registerNodeTypes("Node_JSON", 1, NodeFactory, NULL,-1); // last 2 args can be used to add only a subset of nodes (or to sort their order inside the context menu)
...
ImGui::Node* VGraph::NodeFactory(int nodeNum, const ImVec2& pos, const ImGui::NodeGraphEditor& /*nge*/)
{
